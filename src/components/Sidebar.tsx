...
import { Clapperboard, Film, Users, History, Settings, Sparkles, ClipboardCheck, Activity, Images } from 'lucide-react';

export type NavTab = 'director' | 'keyframes' | 'monitor' | 'studio' | 'characters' | 'review' | 'history' | 'settings';
