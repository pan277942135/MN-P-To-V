...
import { Clapperboard, Film, Users, History, Settings, Sparkles, ClipboardCheck, Activity, Image as ImageIcon, ListVideo, ListOrdered } from 'lucide-react';

export type NavTab = 'director' | 'shot-list' | 'keyframes' | 'keyframe-assets' | 'keyframe-qa' | 'video-blueprint' | 'monitor' | 'studio' | 'characters' | 'review' | 'history' | 'settings';
